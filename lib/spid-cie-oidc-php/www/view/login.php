                                            ...
                                            <div id="spid-idp-button-medium-get" class="spid-idp-button spid-idp-button-tip spid-idp-button-relative">
                                                <ul id="spid-idp-list-medium-root-get" class="spid-idp-button-menu" aria-labelledby="spid-idp">    
                                                    ...
                                                    <li class="spid-idp-button-link" data-idp="intesigroup">
                                                        <a href="<?php echo $BASEURL; ?>/oidc/rp/<?php echo $DOMAIN; ?>/authz/<?php echo base64_encode('http://trust-anchor.org:8000/'); ?>/<?php echo base64_encode('http://trust-anchor.org:8000/oidc/op/'); ?>?state=Intesi Group"><span class="spid-sr-only">Intesi Group</span><img src="<?php echo $BASEURL; ?>/assets/spid-sp-access-button/img/spid-idp-intesigroupspid.svg" onerror="this.src='<?php echo $BASEURL; ?>/assets/spid-sp-access-button/img/spid-idp-intesigroupspid.png'; this.onerror=null;" alt="Intesi Group" /></a>
                                                    </li>
